    ...
    <div className="navbar bg-base-100 font-poppins justify-between">
      <div className="md:navbar-start  items-center">
        <div className="dropdown z-20">
          ...
          <div
            tabIndex={0}
            className="menu menu-sm gap-4 dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 border border-btn-1 py-5 md:text-lg md:py-7 text-lg "
          >
            <span className="hover:text-[#3d52a0] ">
              <NavLink className="px-4 py-2 rounded-lg" to="/">
                Home
            ...
            {user && (
              <>
                ...
                <div className="dropdown  dropdown-bottom">
                  ...
                  <ul
                    tabIndex={0}
                    className="-ml-[9px] border border-t-0 pl-9 dropdown-content z-50 menu p-3  bg-base-100 rounded-b-xl w-52 font-semibold  space-y-2"
                  >
                    <li>
